...
def assign_asset(
    ...
    return service.assign(asset_id, data)
...
def return_asset(
    ...
    return service.return_asset(asset_id, data)
...
def reassign_asset(
    ...
    return service.reassign(asset_id, data)
...
def list_employee_allocations(
    ...
    return service.list_by_employee(employee_id, page=page, page_size=page_size)
